  ...
  const achievements = [
    {
      ...
      technologies: ["AI Crowd Prediction", "IoT Integration", "Real-time Analytics", "Mobile Development", "Web Development"],
    ...
    },
    {
      ...
      technologies: ["Artificial Intelligence", "Internet of Things", "Web Development"],
